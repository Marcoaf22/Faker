...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $jobTitleFormat = [
        'panadero', 'albañil', 'carpintero', 'plomero', 'mecánico', 'artesano', 'trabajador', 'obrero', 'dentista', 'médico', 'periodista', 'enfermera', 'psiquiatra', 'comerciante', 'cirujano', 'vendedor', 'vendedora', 'agricultor', 'recepcionista', 'deportista', 'atleta', 'músico', 'artista'
    ];

    protected static $companyPrefix = ['Asociación', 'Centro', 'Corporación', 'Empresa', 'Gestora', 'Global', 'Grupo', 'Cooperativa'];
